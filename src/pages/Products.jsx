...
import { Filter, ChevronLeft, ChevronRight, Search, ArrowRight } from 'lucide-react';
        ...
        <div className="products-page">
            <div className="page-header">
                <div className="container">
                    ...
                    <h1>{activeCategory === 'All' ? 'Our Products Catalog' : activeCategory}</h1>
                    <p className="product-cat">{filteredProducts.length} Products Available</p>
                </div>
            </div>
            ...
            <div className="container section products-layout">
                    ...
                    <ul className="category-list">
                        {categories.map(cat => {
                            ...
                            return (
                                ...
                                >
                                    <span>{cat}</span>
                                    <span style={{ marginLeft: 'auto', opacity: 0.6, fontSize: '.8rem' }}>({count})</span>
                                </li>
                            );
                        })}
                    </ul>
                ...
                <div className="products-grid-container">
                    ...
                    {currentProducts.length > 0 ? (
                        ...
                        <div style={{ textAlign: 'center', padding: '4rem 2rem', background: 'var(--bg-white)', borderRadius: 'var(--r-lg)', border: '1px solid var(--border)' }}>
                            <h3 style={{ fontSize: '1.2rem', color: 'var(--text-heading)', marginBottom: '.5rem' }}>No products found</h3>
